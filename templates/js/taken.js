...
function fetchtaken() {
    ...
    fetch('https://backend-1-qp4n.onrender.com/takenbooks')
...
const addBorrowButtonEvents = () => {
    ...
    borrowButtons.forEach(button => {
        button.addEventListener('click', (event) => {
            ...
            fetch(`https://backend-1-qp4n.onrender.com/books/${bookId}`, {
                method: 'PUT',
                headers: {
...
function fetchmagazine() {
    ...
    com.style.display="none";
    fetch('https://backend-1-qp4n.onrender.com/takenmagazine')
    .then(response => response.json())
    .then(data => {
...
function fetchcomic() {
    ...
    fetch('https://backend-1-qp4n.onrender.com/takencomic')
    .then(response => response.json())
    .then(data => {
